...
import { AppTheme, colors as staticColors, useThemedStyles } from '../../../theme';
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <AppText variant="subtitle">Submission & tracking</AppText>
        </View>
        <Button
          title="New Bill"
          icon={<Ionicons name="add-outline" color={staticColors.white} />}
          iconPosition="left"
          gradient="warning"
